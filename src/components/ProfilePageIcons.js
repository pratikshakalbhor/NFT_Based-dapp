/**
 * Icon components for ProfilePage
 * Reusable SVG icon components for cleaner component structure
 */
...
export const NFTGridIcon = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <rect x="3" y="5" width="8" height="8" rx="1" fill="none" stroke="currentColor" strokeWidth="2" />
    <rect x="13" y="5" width="8" height="8" rx="1" fill="none" stroke="currentColor" strokeWidth="2" />
    <rect x="3" y="15" width="8" height="4" rx="1" fill="none" stroke="currentColor" strokeWidth="2" />
    <rect x="13" y="15" width="8" height="4" rx="1" fill="none" stroke="currentColor" strokeWidth="2" />
  </svg>
);
